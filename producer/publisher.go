...
func main(){
	...
	utils.GenerateLogs(err, "Error in opening a channel on rabbit")
	defer channel.Close()
	...
	utils.GenerateLogs(err, "Error in creating queue on server")
	...
	utils.GenerateLogs(err, "Error in publishing message to rabbit")
